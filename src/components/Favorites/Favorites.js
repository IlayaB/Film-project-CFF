        ...
        <div className='play-list' id='down'>
            <div className='list-group'>
                ...
                <div className="list-name-bar">
                    <form onSubmit={handleSubmit}>
                        <input onChange={handleInputOnChange} type='text' placeholder='Enter a list name' className='search-bar list-name-bar' disabled={isCreated} />
                    </form>
                </div>
            </div>
            ...
            {isCreated ?
                <div className="create-list-button">
                    <NavLink to={`/movielist`} className='button list-button'>Go to the list "{listName.length > 0 ? listName : 'list'}"</NavLink>
                </div>
                :
                <div className="create-list-button">
                    <button onClick={() => handleCreateListButton()} className='button search-submit'>Save the list</button>
                </div>
            }
        </div>
    );
